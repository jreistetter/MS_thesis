...
def main():
    import os
    root_path = os.path.expanduser('~/Dropbox/thesis_work/PMN_output/8.10.12_30_mods_0.1_highvar/')
    mods_path = root_path + '8.10.12_30_mods_0.1_highvar_mods_output.txt'
    protein_path = root_path + '8.10.12_30_mods_0.1_highvar_mods_output_pathways.txt'
    
    out_path = root_path + '8.10.12_30_mods_0.1_highvar_mods_parsed.txt'
    members_out = root_path + '8.10.12_30_mods_0.1_highvar_mods_members.txt'
    pathways_out = root_path + '8.10.12_30_mods_0.1_highvar_mods_pathways.txt'
